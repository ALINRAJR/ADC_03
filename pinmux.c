...
const Pinconfig_t ADCPins[]={
		 /* Selecting ADC functionality for the selected pins */
		{  LPC_GPIO0,  AD0_0,  FUNC1  },      //AD0_0
		{  LPC_GPIO0,  AD0_1,  FUNC1  },      //AD0_1
		{  LPC_GPIO0,  AD0_2,  FUNC1  },      //AD0_2
		{  LPC_GPIO0,  AD0_3,  FUNC1  },      //AD0_3/AOUT
...
void vPinmuxInitialize(void)
{
	...
	/* Selecting ADC functionality for the selected pins */
	vPinmuxSel(ADCPins[0].GPIOx,ADCPins[0].pin,ADCPins[0].func);
	vPinmuxSel(ADCPins[1].GPIOx,ADCPins[1].pin,ADCPins[1].func);
	vPinmuxSel(ADCPins[2].GPIOx,ADCPins[2].pin,ADCPins[2].func);
	vPinmuxSel(ADCPins[3].GPIOx,ADCPins[3].pin,ADCPins[3].func);
	vPinmuxSel(ADCPins[4].GPIOx,ADCPins[4].pin,ADCPins[4].func);
	vPinmuxSel(ADCPins[5].GPIOx,ADCPins[5].pin,ADCPins[5].func);
	vPinmuxSel(ADCPins[6].GPIOx,ADCPins[6].pin,ADCPins[6].func);
	vPinmuxSel(ADCPins[7].GPIOx,ADCPins[7].pin,ADCPins[7].func);
